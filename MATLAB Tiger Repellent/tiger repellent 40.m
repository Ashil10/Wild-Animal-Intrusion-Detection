...
freq = 40000; % High-frequency sine wave (40 kHz)
...
if length(baseSound) < length(sineWave)
    ...
    baseSound = baseSound(1:length(sineWave)); % Trim if longer
end
...
audiowrite('tiger_repellent_40kHz.wav', combinedSound, Fs);

disp('40 kHz sine wave with base sound generated and saved as tiger_repellent_40kHz.wav.');
