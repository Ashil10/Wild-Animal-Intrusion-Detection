...
freq = 55000; % High-frequency sine wave (55 kHz)
...
audiowrite('tiger_repellent_55kHz.wav', combinedSound, Fs);

disp('55 kHz sine wave with base sound generated and saved as tiger_repellent_55kHz.wav.');
