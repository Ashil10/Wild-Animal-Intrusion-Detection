...
freq = 30000; % High-frequency sine wave (30 kHz)
...
audiowrite('tiger_repellent_30kHz.wav', combinedSound, Fs);

disp('30 kHz sine wave with base sound generated and saved as tiger_repellent_30kHz.wav.');
