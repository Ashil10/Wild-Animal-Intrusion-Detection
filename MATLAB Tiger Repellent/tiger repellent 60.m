...
freq = 60000; % High-frequency sine wave (60 kHz)
...
audiowrite('tiger_repellent_60kHz.wav', combinedSound, Fs);

disp('60 kHz sine wave with base sound generated and saved as tiger_repellent_60kHz.wav.');
