...
freq = 35000; % High-frequency sine wave (35 kHz)
...
% Ensure both sounds are the same length
...
audiowrite('tiger_repellent_35kHz.wav', combinedSound, Fs);

disp('35 kHz sine wave with base sound generated and saved as tiger_repellent_35kHz.wav.');
